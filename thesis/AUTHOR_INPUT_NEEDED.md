...
## Williamson (1985) removed from the reference list (author decision, 2026-07-19)

The author requires all reference-list entries to be freely obtainable; the Williamson monograph is not. Per APA 7 secondary-citation rules, all five in-text uses (§2.2 ×2, §5.2 ×3) now read "(Williamson, 1985, as cited in Tsai & Urmetzer, 2024)" — verified: Tsai & Urmetzer (2024) cite Williamson (1985) in their reference list and discuss TCE directly (A03.pdf, pp. 2, 12, 26) — and the Williamson entry was deleted from 7_References.md. Barney (1991) was then removed the same way (author decision, same day): all five in-text uses (§2.2 ×2, §5.2 ×3) now read "(Barney, 1991, as cited in Tsai & Urmetzer, 2024)" — verified: Tsai & Urmetzer (2024) cite Barney (1991) in text (pp. 2, 13–14) and in their reference list (p. 21) — and the Barney entry was deleted from 7_References.md. Reference count is now 33 entries. Pegoraro et al. (2022) STAYS unchanged — the author located the free PMC full text. T01/T02 in the corpus file remain as records but are no longer reference-list entries.
