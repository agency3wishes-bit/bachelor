...
The author requires all reference-list entries to be freely obtainable; the Williamson monograph is not. Per APA 7 secondary-citation rules, all five in-text uses (§2.2 ×2, §5.2 ×3) now read "(Williamson, 1985, as cited in Tsai & Urmetzer, 2024)" — verified: Tsai & Urmetzer (2024) cite Williamson (1985) in their reference list and discuss TCE directly (A03.pdf, pp. 2, 12, 26) — and the Williamson entry was deleted from 7_References.md. Barney (1991) is RETAINED (free PDFs via Google Scholar; also cited in the benchmark thesis with the same DOI). Reference count is now 34 entries. T01 in the corpus file remains as a record but is no longer a reference-list entry.
